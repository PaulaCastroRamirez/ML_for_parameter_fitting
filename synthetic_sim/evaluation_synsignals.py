...
outstr = r'C:\Users\pcastror\Desktop\internship\ML_network\FINAL_CODES2\Simulations\exp1_MRImodelZeppelin_ntrain8000_nval2000_ntest1000_SNR70\syn'
num = 50  ## signal number to plot. note that depending on the set i will have different bounds!

bvals_path = r'C:\Users\pcastror\Desktop\internship\ML_network\HCP\bvals.txt'
...
with open('{}_GT_paramtrain.bin'.format(outstr), 'rb') as file:
