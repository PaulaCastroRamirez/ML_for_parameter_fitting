...
# =============================================================================
	...
	if mrimodel=='Zeppelin':
		...
		qnet = network3.mrisig([Nmeas,totpar],0.0,'Zeppelin',mriprot, g)
	...
	kappa = 250  # Concentration parameter
	mu = qnet.param_max[0]/2  # Mean direction (π radians)
    # Parameters for the Von Mises distribution
	mu1 = qnet.param_min[0]  # Mean direction for the first peak
	kappa1 = 2.0  # Concentration parameter for the first peak
	mu2 = qnet.param_max[0] # Mean direction for the second peak (π radians)
	kappa2 = 2.0  # Concentration parameter for the second peak
    ...
    ### theta ###
    # Parameters for the Von Mises distribution
	kappa1 = 70  # Concentration parameter
	mu1 = qnet.param_max[1]/2  # Mean direction (π radians)
	mu2 = 0.0  # Mean direction for the first peak
	kappa2 = 0.5  # Concentration parameter for the first peak
	mu3 = qnet.param_max[1]/2  # Mean direction for the second peak (π radians)
	kappa3 = 0.5  # Concentration parameter for the second peak
