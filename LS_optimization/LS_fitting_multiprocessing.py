...
#image_idx_list = ['10307', '10408', '1006', '11107']
image_idx_list = ['15017']

print('')

prmtrain = np.zeros((2948399,9))

hello = (prmtrain[prmtrain.shape[0]%100:,:])
...
for image_idx in image_idx_list:
    print('')
    print('')
    print(f'********** FITTING IMAGE 1{image_idx} WITH LEAST SQUARES, NO GNL CORRETION **********')
    print('')
    print('')

    # Read the image
# =============================================================================
#     file_path_nii = r'C:\Users\pcastror\Desktop\internship\ML_network\HCP\HCP\ground_truths\GT_1' + image_idx + '_dwi_noised_GNL.nii'
#     file_path_bvec  = r'C:\Users\pcastror\Desktop\internship\ML_network\HCP\HCP\1' +  image_idx + '_DWI.txt'
...
# =============================================================================
    ...
    file_path_nii = r'C:\Users\pcastror\Desktop\internship\ML_network\HCP\HCP\ground_truths\GT_1' + image_idx + '_dwi_noised_GNL.nii'
    file_path_bvec  = r'C:\Users\pcastror\Desktop\internship\ML_network\HCP\HCP\1' +  image_idx + '_bvecs'
    file_path_bval  = r'C:\Users\pcastror\Desktop\internship\ML_network\HCP\HCP\1' +  image_idx + '_bvals'

    dwi, affine = load_nifti(file_path_nii)
    g = (np.loadtxt(file_path_bvec)).T
    bval = np.loadtxt(file_path_bval)
    ...
    path_msk = r'C:\Users\pcastror\Desktop\internship\ML_network\HCP\HCP\ground_truths\GT_1' + image_idx + '_mask.bin'
    ...
    plt.title(f'Masked dwi dataset 1{image_idx}')
    plt.axis('off')
    plt.show()
    ...
    print('') 
    print(f'Execution time for dataset with num iter {niter}: ', end_time - start_time, ' seconds')
    print('')
    print('... Done!')
    print('')
    ...
    if vis == 1: 
        ...
        plt.suptitle(f'Results from fitting with LS no GNL correction. Dataset: 1{image_idx}', fontsize=25, color='white')
    ...
    print('')
    output_file_name = r'C:\Users\pcastror\Desktop\internship\ML_network\FINAL_CODES2\LS_experiments\parameter_estimations\LS_1' + image_idx + '_dwi_GNL_NO_correction'
